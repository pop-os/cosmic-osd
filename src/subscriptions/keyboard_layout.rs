use cosmic::cctk::cosmic_protocols::keyboard_layout::v1::client::zcosmic_keyboard_layout_v1::ZcosmicKeyboardLayoutV1;
use cosmic::cctk::keyboard_layout::{KeyboardLayoutHandler, KeyboardLayoutState};
use cosmic::cctk::sctk::registry::{ProvidesRegistryState, RegistryState};
use cosmic::cctk::sctk::seat::{Capability, SeatHandler, SeatState};
use cosmic::cctk::sctk::{self};
use cosmic::cctk::wayland_client::globals::registry_queue_init;
use cosmic::cctk::wayland_client::protocol::{wl_keyboard, wl_seat};
use cosmic::cctk::wayland_client::{Connection, QueueHandle, delegate_noop};
